...
volatile uint8_t g_req_status = 0;
volatile uint8_t g_req_backLen = 0;
volatile uint8_t g_req_tag0 = 0;
volatile uint8_t g_req_tag1 = 0;

volatile uint8_t g_anticoll_status = 0;
volatile uint8_t g_anticoll_backLen = 0;
...
uint8_t MFRC522_Request(uint8_t reqMode, uint8_t *TagType)
{
    ...
    g_req_status = status;
    g_req_backLen = backLen;
    g_req_tag0 = TagType[0];
    g_req_tag1 = TagType[1];
...
uint8_t MFRC522_Anticoll(uint8_t *serNum) {
    ...
    g_anticoll_status = status;
    g_anticoll_backLen = backLen;
